# -*- coding: utf-8 -*-
"""
 @Time    : 2019/3/2 0002 下午 2:31
 @Author  : Shanshan Wang
 @Version : Python3.5
 @Function: 使用pytorch 框架使用CNN网络结构
"""
import torch
...
class CNN(nn.Module):
    ...
    def forward(self,x):
        ...
        output=self.out(x)
        return output,x #return x for 可视化
...
if __name__ == '__main__':
    ...
    #pick 2000 samples to speed up the test
    ...
    for epoch in range(EPOCH):
        for step ,(b_x,b_y) in enumerate(train_loader):# gives batch data, normalize x when iterate train_loader
           ...
           if step%50==0:
               ...
               #使用tsne 可视化trained flatten layer
    ...
    pred_y=torch.max(test_output,1)[1].data.numpy()
    print('pred_y:',pred_y)
    print('test_y:',test_y[:10].data.numpy())
